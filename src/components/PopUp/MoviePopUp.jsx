              ...
              <div className="bg-neutral-800 rounded-lg shadow-xl">
                ...
                <div className="flex px-4 py-3 border-t border-neutral-700">
                  <div className="flex gap-2">
                    <button
                      className="flex items-center justify-center bg-red-700 hover:bg-red-800 text-white font-medium px-4 py-2 rounded"
                      onClick={() => {
                        setShowModal(false);
                        playMovie(movieInfo);
                      }}
                    ...
                    {isInMyList ? (
                      <button
                        className="flex items-center justify-center border border-white text-white font-medium py-2 px-4 rounded"
                        onClick={() => {
                  ...
                  <button
                    className="flex items-center justify-center bg-neutral-700 text-white font-medium py-2 px-4 rounded ml-auto"
                    onClick={() => setShowModal(false)}
                  >
                    Close
                  </button>
