...
function MoviePopUp(props) {
  ...
  const { convertGenres } = useGenresConverter();
          ...
          <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
            <div className="relative w-auto mt-24 sm:my-6 mx-4 max-w-3xl">
              ...
              <motion.div
                ...
                className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-neutral-800 outline-none focus:outline-none"
              >
                {/*header*/}
                <button
                  ...
                  >
                    <div className="relative p-2 py-5 sm:p-6 flex-auto">
                      <h1 className="flex -mt-4 text-neutral-400 text-sm leading-relaxed">
                        ...
                        <div className="ml-2">
                          {PopupInfo.vote_average && (
                            <Rating
                              value={PopupInfo.vote_average / 2}
                              readOnly
                              style={{ maxWidth: "1rem" }}
                            />
                          )}
                      ...
                      <h1 className="flex text-neutral-400 text-sm leading-relaxed">
                        Genres :
                        {PopupInfo.genre_ids &&
                          convertGenres(PopupInfo.genre_ids).map((Genres) => {
                            return (
